...
import { 
  ...
  LayoutGrid, Settings, Search, BarChart3, Megaphone, Trophy
} from 'lucide-react';
                                         ...
                                         <tr key={amb.id} className="hover:bg-white/5 transition-colors">
                                             <td className="p-4">
                                                 <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${
                                                     amb.rank === 1 ? 'bg-yellow-500 text-black' :
                             ...
                             {['video', 'blog', 'ebook', 'gallery', 'faqs', 'reviews'].map(sub => (
                                 <button
                                    ...
                                    className={`px-4 py-2 text-sm font-bold capitalize transition-colors ${
                                        activeSubTab === sub ? 'text-white border-b-2 border-blue-500' : 'text-slate-500 hover:text-white'
                                    }`}
                                 >
                                     {sub}
                                 </button>
